            ...
            return students.map((student,index)=>{
                return(
                    <li key={index}>
                            ...
                            <button className="button button2" onClick={()=>deleteStudent(student.no)}>DELETE</button>
                            <button className="button button3" onClick={()=>updateStudent(student.no)}>UPDATE</button>
                    </li>
